...
void MyFrame::connexion() { // fenêtre de connexion
...
void MyFrame::accueil(){ //fenêtre d'acceuil
...
void MyFrame::compte() { //fenêtre des différents comptes (pas fini)
...
void MyFrame::OnRetour(wxCommandEvent& event) { //aller de la fenêtre connexion à la fenêtre accueil (bouton retour)
...
void MyFrame::OnConnexion(wxCommandEvent& event) { //vérifie le compte (ID et mot de passe) et ouvre la fenêtre compte et ferme accueil
...
void MyFrame::OnInscription(wxCommandEvent& event) { // ouvre la page connexion
...
void MyFrame::OnBtnValiderClicked(wxCommandEvent& event) //récapitule les données du client
{
...
void MyFrame::Oncacher(wxCommandEvent& event) //permet de cacher le bouton valider si toutes les cases ne sont pas remplis
{
    bool bOK = true;
...
void MyFrame::OnExit(wxCommandEvent& event) //pour quitter la banque
{
...
void MyFrame::OnBtnAnnulerClicked(wxCommandEvent& event) //pour annuler le formulaire
{
    int reponse = wxMessageBox(_T("Annuler le formulaire ?"), // Message à afficher
        _T("Confirmation"), // Titre de la boite de message
        wxYES_NO | wxICON_QUESTION); // Style
...
void MyFrame::OnSaveCustomers(wxCommandEvent& event) //créer, sauvegarder un client et retour à la page d'accueil
{
...
bool verify_connection(int id_user, std::string mdp) { //vérifie si L'ID et le ot de passe du client existe dans la base de donnée
